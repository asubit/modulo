...
class TicketController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tickets = $em->getRepository('SupportBundle:Ticket')->findAll();
    ...
    {
        $ticket = new Ticket();
        $form = $this->createForm('SupportBundle\Form\TicketType', $ticket);
    ...
    {
        $deleteForm = $this->createDeleteForm($ticket);
        $editForm = $this->createForm('SupportBundle\Form\TicketType', $ticket);
