...
use ModuloBundle\Entity\Menu;
use ModuloBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $menus = $em->getRepository('ModuloBundle:Menu')->findAll();
    ...
    {
        $menu = new Menu();
        $form = $this->createForm('ModuloBundle\Form\MenuType', $menu);
    ...
    {
        $deleteForm = $this->createDeleteForm($menu);
        $editForm = $this->createForm('ModuloBundle\Form\MenuType', $menu);
